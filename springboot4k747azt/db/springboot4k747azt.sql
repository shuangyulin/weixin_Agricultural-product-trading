...
--
-- Host: localhost    Database: springboot4k747azt
-- ------------------------------------------------------
...
--
-- Current Database: `springboot4k747azt`
--

/*!40000 DROP DATABASE IF EXISTS `springboot4k747azt`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `springboot4k747azt` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `springboot4k747azt`;
...
INSERT INTO `address` VALUES (1,'2025-01-08 02:59:10',11,'宇宙银河系金星1号','金某','13823888881','是'),(2,'2025-01-08 02:59:10',12,'宇宙银河系木星1号','木某','13823888882','是'),(3,'2025-01-08 02:59:10',13,'宇宙银河系水星1号','水某','13823888883','是'),(4,'2025-01-08 02:59:10',14,'宇宙银河系火星1号','火某','13823888884','是'),(5,'2025-01-08 02:59:10',15,'宇宙银河系土星1号','土某','13823888885','是'),(6,'2025-01-08 02:59:10',16,'宇宙银河系月球1号','月某','13823888886','是'),(7,'2025-01-08 02:59:10',17,'宇宙银河系黑洞1号','黑某','13823888887','是'),(8,'2025-01-08 02:59:10',18,'宇宙银河系地球1号','地某','13823888888','是');
...
CREATE TABLE `cart` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `tablename` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT 'nongchanpin' COMMENT '商品表名',
  `userid` bigint(20) NOT NULL COMMENT '用户id',
  ...
  PRIMARY KEY (`id`),
  KEY `price` (`price`),
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`price`) REFERENCES `nongchanpin` (`price`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `chanpinleixing` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `chanpinleixing` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品类型',
  PRIMARY KEY (`id`),
  UNIQUE KEY `chanpinleixing` (`chanpinleixing`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='产品类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chanpinleixing` VALUES (1,'2025-01-08 02:59:09','产品类型1'),(2,'2025-01-08 02:59:09','产品类型2'),(3,'2025-01-08 02:59:09','产品类型3'),(4,'2025-01-08 02:59:09','产品类型4'),(5,'2025-01-08 02:59:09','产品类型5'),(6,'2025-01-08 02:59:09','产品类型6'),(7,'2025-01-08 02:59:09','产品类型7'),(8,'2025-01-08 02:59:09','产品类型8');
...
INSERT INTO `chargerecord` VALUES (1,'2025-01-08 02:59:10',1,'用户名1','角色1',1),(2,'2025-01-08 02:59:10',2,'用户名2','角色2',2),(3,'2025-01-08 02:59:10',3,'用户名3','角色3',3),(4,'2025-01-08 02:59:10',4,'用户名4','角色4',4),(5,'2025-01-08 02:59:10',5,'用户名5','角色5',5),(6,'2025-01-08 02:59:10',6,'用户名6','角色6',6),(7,'2025-01-08 02:59:10',7,'用户名7','角色7',7),(8,'2025-01-08 02:59:10',8,'用户名8','角色8',8);
...
CREATE TABLE `discussnongchanpin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='农产品评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `jiufentousu`
--

DROP TABLE IF EXISTS `jiufentousu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jiufentousu` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `chanpinmingcheng` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品名称',
  ...
  `tousuneirong` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '投诉内容',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='纠纷投诉';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jiufentousu`
--

LOCK TABLES `jiufentousu` WRITE;
/*!40000 ALTER TABLE `jiufentousu` DISABLE KEYS */;
INSERT INTO `jiufentousu` VALUES (1,'2025-01-08 02:59:09','产品名称1','产品类型1','upload/jiufentousu_tupian1.jpg,upload/jiufentousu_tupian2.jpg,upload/jiufentousu_tupian3.jpg','商家姓名1','投诉内容1','2025-01-08 10:59:09','用户账号1','用户姓名1',''),(2,'2025-01-08 02:59:09','产品名称2','产品类型2','upload/jiufentousu_tupian2.jpg,upload/jiufentousu_tupian3.jpg,upload/jiufentousu_tupian4.jpg','商家姓名2','投诉内容2','2025-01-08 10:59:09','用户账号2','用户姓名2',''),(3,'2025-01-08 02:59:09','产品名称3','产品类型3','upload/jiufentousu_tupian3.jpg,upload/jiufentousu_tupian4.jpg,upload/jiufentousu_tupian5.jpg','商家姓名3','投诉内容3','2025-01-08 10:59:09','用户账号3','用户姓名3',''),(4,'2025-01-08 02:59:10','产品名称4','产品类型4','upload/jiufentousu_tupian4.jpg,upload/jiufentousu_tupian5.jpg,upload/jiufentousu_tupian6.jpg','商家姓名4','投诉内容4','2025-01-08 10:59:10','用户账号4','用户姓名4',''),(5,'2025-01-08 02:59:10','产品名称5','产品类型5','upload/jiufentousu_tupian5.jpg,upload/jiufentousu_tupian6.jpg,upload/jiufentousu_tupian7.jpg','商家姓名5','投诉内容5','2025-01-08 10:59:10','用户账号5','用户姓名5',''),(6,'2025-01-08 02:59:10','产品名称6','产品类型6','upload/jiufentousu_tupian6.jpg,upload/jiufentousu_tupian7.jpg,upload/jiufentousu_tupian8.jpg','商家姓名6','投诉内容6','2025-01-08 10:59:10','用户账号6','用户姓名6',''),(7,'2025-01-08 02:59:10','产品名称7','产品类型7','upload/jiufentousu_tupian7.jpg,upload/jiufentousu_tupian8.jpg,upload/jiufentousu_tupian1.jpg','商家姓名7','投诉内容7','2025-01-08 10:59:10','用户账号7','用户姓名7',''),(8,'2025-01-08 02:59:10','产品名称8','产品类型8','upload/jiufentousu_tupian8.jpg,upload/jiufentousu_tupian1.jpg,upload/jiufentousu_tupian2.jpg','商家姓名8','投诉内容8','2025-01-08 10:59:10','用户账号8','用户姓名8','');
/*!40000 ALTER TABLE `jiufentousu` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `mycoupon` (
  ...
  `shangjiazhanghao` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商户名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='我的优惠券';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `newstype` VALUES (1,'2025-01-08 02:59:10','分类名称1'),(2,'2025-01-08 02:59:10','分类名称2'),(3,'2025-01-08 02:59:10','分类名称3'),(4,'2025-01-08 02:59:10','分类名称4'),(5,'2025-01-08 02:59:10','分类名称5'),(6,'2025-01-08 02:59:10','分类名称6'),(7,'2025-01-08 02:59:10','分类名称7'),(8,'2025-01-08 02:59:10','分类名称8');
...
CREATE TABLE `nongchanpin` (
  ...
  `caizhairiqi` datetime DEFAULT NULL COMMENT '采摘日期',
  ...
  `storeupnum` int(11) DEFAULT '0' COMMENT '收藏数',
  PRIMARY KEY (`id`),
  KEY `nongchanpin_price` (`price`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='农产品';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nongchanpin` VALUES (1,'2025-01-08 02:59:09','产品名称1','产品类型1','upload/nongchanpin_tupian1.jpg,upload/nongchanpin_tupian2.jpg,upload/nongchanpin_tupian3.jpg','简介1','产地1','2025-01-08 10:59:09','商家账号1','商家姓名1',1,99,1,1,'2025-01-08 10:59:09',0,0,99.9,1,1),(2,'2025-01-08 02:59:09','产品名称2','产品类型2','upload/nongchanpin_tupian2.jpg,upload/nongchanpin_tupian3.jpg,upload/nongchanpin_tupian4.jpg','简介2','产地2','2025-01-08 10:59:09','商家账号2','商家姓名2',2,99,2,2,'2025-01-08 10:59:09',0,0,99.9,1,2),(3,'2025-01-08 02:59:09','产品名称3','产品类型3','upload/nongchanpin_tupian3.jpg,upload/nongchanpin_tupian4.jpg,upload/nongchanpin_tupian5.jpg','简介3','产地3','2025-01-08 10:59:09','商家账号3','商家姓名3',3,99,3,3,'2025-01-08 10:59:09',0,0,99.9,1,3),(4,'2025-01-08 02:59:09','产品名称4','产品类型4','upload/nongchanpin_tupian4.jpg,upload/nongchanpin_tupian5.jpg,upload/nongchanpin_tupian6.jpg','简介4','产地4','2025-01-08 10:59:09','商家账号4','商家姓名4',4,99,4,4,'2025-01-08 10:59:09',0,0,99.9,1,4),(5,'2025-01-08 02:59:09','产品名称5','产品类型5','upload/nongchanpin_tupian5.jpg,upload/nongchanpin_tupian6.jpg,upload/nongchanpin_tupian7.jpg','简介5','产地5','2025-01-08 10:59:09','商家账号5','商家姓名5',5,99,5,5,'2025-01-08 10:59:09',0,0,99.9,1,5),(6,'2025-01-08 02:59:09','产品名称6','产品类型6','upload/nongchanpin_tupian6.jpg,upload/nongchanpin_tupian7.jpg,upload/nongchanpin_tupian8.jpg','简介6','产地6','2025-01-08 10:59:09','商家账号6','商家姓名6',6,99,6,6,'2025-01-08 10:59:09',0,0,99.9,1,6),(7,'2025-01-08 02:59:09','产品名称7','产品类型7','upload/nongchanpin_tupian7.jpg,upload/nongchanpin_tupian8.jpg,upload/nongchanpin_tupian1.jpg','简介7','产地7','2025-01-08 10:59:09','商家账号7','商家姓名7',7,99,7,7,'2025-01-08 10:59:09',0,0,99.9,1,7),(8,'2025-01-08 02:59:09','产品名称8','产品类型8','upload/nongchanpin_tupian8.jpg,upload/nongchanpin_tupian1.jpg,upload/nongchanpin_tupian2.jpg','简介8','产地8','2025-01-08 10:59:09','商家账号8','商家姓名8',8,99,8,8,'2025-01-08 10:59:09',0,0,99.9,1,8);
...
INSERT INTO `shangjia` VALUES (21,'2025-01-08 02:59:09','商家账号1','123456','商家姓名1','男','upload/shangjia_touxiang1.jpg','13823888881','','是','',200,0,'','',''),(22,'2025-01-08 02:59:09','商家账号2','123456','商家姓名2','男','upload/shangjia_touxiang2.jpg','13823888882','','是','',200,0,'','',''),(23,'2025-01-08 02:59:09','商家账号3','123456','商家姓名3','男','upload/shangjia_touxiang3.jpg','13823888883','','是','',200,0,'','',''),(24,'2025-01-08 02:59:09','商家账号4','123456','商家姓名4','男','upload/shangjia_touxiang4.jpg','13823888884','','是','',200,0,'','',''),(25,'2025-01-08 02:59:09','商家账号5','123456','商家姓名5','男','upload/shangjia_touxiang5.jpg','13823888885','','是','',200,0,'','',''),(26,'2025-01-08 02:59:09','商家账号6','123456','商家姓名6','男','upload/shangjia_touxiang6.jpg','13823888886','','是','',200,0,'','',''),(27,'2025-01-08 02:59:09','商家账号7','123456','商家姓名7','男','upload/shangjia_touxiang7.jpg','13823888887','','是','',200,0,'','',''),(28,'2025-01-08 02:59:09','商家账号8','123456','商家姓名8','男','upload/shangjia_touxiang8.jpg','13823888888','','是','',200,0,'','','');
...
INSERT INTO `users` VALUES (1,'admin','admin','upload/image1.jpg','管理员','2025-01-08 02:59:10');
...
INSERT INTO `yonghu` VALUES (11,'2025-01-08 02:59:09','用户账号1','123456','用户姓名1','男','upload/yonghu_touxiang1.jpg','13823888881',200,0,'','',''),(12,'2025-01-08 02:59:09','用户账号2','123456','用户姓名2','男','upload/yonghu_touxiang2.jpg','13823888882',200,0,'','',''),(13,'2025-01-08 02:59:09','用户账号3','123456','用户姓名3','男','upload/yonghu_touxiang3.jpg','13823888883',200,0,'','',''),(14,'2025-01-08 02:59:09','用户账号4','123456','用户姓名4','男','upload/yonghu_touxiang4.jpg','13823888884',200,0,'','',''),(15,'2025-01-08 02:59:09','用户账号5','123456','用户姓名5','男','upload/yonghu_touxiang5.jpg','13823888885',200,0,'','',''),(16,'2025-01-08 02:59:09','用户账号6','123456','用户姓名6','男','upload/yonghu_touxiang6.jpg','13823888886',200,0,'','',''),(17,'2025-01-08 02:59:09','用户账号7','123456','用户姓名7','男','upload/yonghu_touxiang7.jpg','13823888887',200,0,'','',''),(18,'2025-01-08 02:59:09','用户账号8','123456','用户姓名8','男','upload/yonghu_touxiang8.jpg','13823888888',200,0,'','','');
...
-- Dump completed on 2025-02-26 15:38:40
